    ...
    <>
      ...
      <main className="mx-auto max-w-6xl my-12">
        ...
        <p>
          ...
          hiệu bán lẻ thuộcTập Đoàn Masan Group. Ra đời từ năm 2014 cho đến nay,
          hệ thống WinMart & WinMart+ không ngừng phát triển vươn lên, ra mắt
          với hơn 132 siêu thị WinMart và gần 3000 cửa hàng WinMart+ phủ rộng
          khắp Việt Nam, mang đến cho người tiêu dùng sự lựa chọn đa dạng về
          chất lượng hàng hóa và dịch vụ, đáp ứng đầy đủ nhu cầu trải nghiệm mua
          sắm từ bình dân đến cao cấp của mọi khách hàng.
        </p>
        <p>
        ...
        <p>
          ...
          địa phương và du khách. Với tầm nhìn dài hạn và mong muốn phát triển
          bền vững, mang đến cho người tiêu dùng Việt những trải nghiệm mua sắm
          tiện lợi với nhiều sự lựa chọn về sản phẩm, an tâm về chất lượng, hệ
          thốngWinMart & WinMart+ đã phủ rộng khắp Việt Nam với hơn 132 siêu thị
          WinMart và gần 3000 cửa hàng WinMart+. WinMart đã và đang nỗ lực không
          ngừng để hoàn thành sứ mệnh của mình:“NƠI AN TÂM MUA SẮM” cho mọi nhà,
